...
return {
    ...
    function QQMusic() {
        ...
        // default artist name (when no song is playing) is "QQйџід№ђ"
        if (artist === "QQйџід№ђ") {
            return false;
        }
